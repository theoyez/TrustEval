...
(async()=>{
 ...
 document.getElementById('copy').addEventListener('click',()=>{ navigator.clipboard.writeText(location.href); const c=document.getElementById('copy'); c.textContent='Copied!'; setTimeout(()=>c.textContent='Copy link',1200); });
})();